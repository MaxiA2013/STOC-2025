...
<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark position-absolute vh-100" style="width: 280px;">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    ?>
      ...
      <li>
        <a href="#" class="nav-link text-white">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
    ...
    ?>
      <li class="mb-1"> <button class="nav-link text-white dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="true">
          Listas
        </button>
        <div class="collapse show" id="dashboard-collapse" style="">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="index.php?page=sintomas_lista" class="nav-link text-white">Sintomas Lista</a></li>
            <li><a href="index.php?page=obra_social_lista" class="nav-link text-white">Obra Social Lista</a></li>
        <!--    <li><a href="index.php?page=especialidad" class="nav-link text-white">Especialidad Listas</a></li>
            <li><a href="index.php?page=metodo-pago" class="nav-link text-white">Metodo Pago Lista</a></li> -->
          </ul>
        </div>
      </li>
